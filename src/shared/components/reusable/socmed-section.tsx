    ...
    <footer className="relative bg-[#FE4F18] overflow-hidden my-3 rounded-2xl py-12 md:mx-8 md:py-16 lg:mx-12 lg:py-20">
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-20">
            <div className="flex flex-col items-center text-center lg:items-start lg:text-left lg:w-[70%]">
                ...
                <p className="text-white text-sm opacity-90">© 2025 Casetudy. All rights reserved.</p>
            </div>
            ...
            <div className="flex flex-col items-center gap-12 lg:flex-row lg:justify-between lg:flex-1 lg:pl-12 lg:relative">
                ...
                <nav className="flex flex-col items-center w-full gap-8 pt-8 pb-8 relative lg:h-full lg:items-start lg:justify-between lg:pt-0 lg:pb-0">
                    ...
                    <button className="text-white text-lg hover:opacity-80 transition-opacity text-center lg:text-left">Case Studies</button>
                    <button className="text-white text-lg hover:opacity-80 transition-opacity text-center lg:text-left">Why us</button>
                    <button className="text-white text-lg hover:opacity-80 transition-opacity text-center lg:text-left">About Casetudy</button>
                    <button className="text-white text-lg hover:opacity-80 transition-opacity text-center lg:text-left">Upload Case Study</button>
                </nav>
